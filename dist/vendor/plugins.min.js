...
Array.min=function(array){return Math.min.apply(Math,array);};var whichCulture=function whichCulture(color,culture){this.currentCulture=culture;this.differenceArray=[];this.lowest="";this.currentColor={hex:color,rgb:{r:0,g:0,b:0}};this.data=[{"hex":"#e20613","name":"red",rgb:{r:0,g:0,b:0},"cultures":{"westernAmerican":["hot","love","passion","power","eroticism","radical (political)","excitement","boldness","devil","danger","desire","anger","spiceness"],"westernEuropean":["danger"],"southAmerican":["success","triumph"],"russia":["revolution","beauty","luck"],"india":["heat","passion","sensuality","energy","the bride"],"northAfrica":["good luck"],"southAfrica":["mourning"],"muslim":["fire"],"asia":["marriage","happiness","prosperity"],"chinese":["wedding","fertility","happiness","success","fortune","good luck"],"japanese":["love","passion","excitement","strength","danger","profound urges","aggression","celebration"],"nativeAmericans":["warmth","passion","heart","emotions","success"]}},{"hex":"#f29101","name":"orange",rgb:{r:0,g:0,b:0},"cultures":{"westernAmerican":["friendly","reliable","warmth"],"westernEuropean":[""],"southAmerican":[""],"russia":[""],"india":["auspicious","desire","energising","holy","fertility"],"northAfrica":[""],"southAfrica":[""],"muslim":[""],"asia":[""],"chinese":["learning","kinship"],"japanese":["enthusiasm","balance","warmth","energy","flamboyance"],"nativeAmericans":["learning","healing"]}},{"hex":"#ffe500","name":"yellow",rgb:{r:0,g:0,b:0},"cultures":{"westernAmerican":["fun","energetic","jubilant","peace","overpowering","cowardly","quarantine","jaundice"],"westernEuropean":[""],"southAmerican":["mourning"],"russia":[""],"india":["divinity","laughter","energising","joy","attracts","love","willpower","repels evil","sensuality"],"northAfrica":[""],"southAfrica":[""],"muslim":["strenght","mourning"],"asia":["sacred","against evil","imperial"],"chinese":["royalty","nourishing","respect"],"japanese":["joy","deceit","courage","cowardice","hazard","illness","idealism"],"nativeAmericans":["illumination","love","overcoming challenges","trouble","inspiration"]}},{"hex":"#33aa52","name":"green",rgb:{r:0,g:0,b:0},"cultures":{"westernAmerican":["earthy","grow","natural","environmental","trust","jealousy","calm","luck","money"],"westernEuropean":[""],"southAmerican":["death"],"russia":[""],"india":["fertility","vitality","life","islam","love","compassion","soothes","universal oneness","happiness","tradition"],"northAfrica":["islam"],"southAfrica":[""],"muslim":["islam","heaven","paradise","god"],"asia":["harmony","peace","eternity","prosperity","family"],"chinese":["growth","life","infidelity","exorcism","sunrise","vigour"],"japanese":["nature","environment","jealousy / envy","eternal life","misfortune","good luck","youth","living willfully"],"nativeAmericans":[""]}},{"hex":"#4980c0","name":"blue",rgb:{r:0,g:0,b:0},"cultures":{"westernAmerican":["quiet","serious","passivity","corporate","liberal","cold","smart","progress","music","trust","freedom","royal","medicine","loyalty","depression","peaceful","objective / rational"],"westernEuropean":[""],"southAmerican":["defeat / trouble"],"russia":[""],"india":["creativity","communication","calm","gods","sacred"],"northAfrica":[""],"southAfrica":[""],"muslim":["heaven","spirituality","immortality","mourning","merciful"],"asia":["wealth","self-cultivation"],"chinese":[""],"japanese":["staility","purity","cold","wealth","loyalty","depression","peace","technology","femininity","life"],"nativeAmericans":["trouble","north","cold","intuition","defeat"]}},{"hex":"#a777b1","name":"purple",rgb:{r:0,g:0,b:0},"cultures":{"westernAmerican":["ambivalence","extravagant","mystery","modesty","virtue","power","sexiness","sophistication","artificial","eclectic","sensual","vanity","royal","decadent","romantic","elegant"],"westernEuropean":[""],"southAmerican":["mourning"],"russia":[""],"india":["air","intuition","understanding"],"northAfrica":[""],"southAfrica":[""],"muslim":[""],"asia":["mourning","expensive"],"chinese":[""],"japanese":["ceremony","spirituality","enlightenment","mourning","nobility","wisdom","royalty","cruelty","arrogance","mysterious"],"nativeAmericans":["healing","gratitude","wisdom"]}},{"hex":"#4b0082","name":"indigo",rgb:{r:0,g:0,b:0},"cultures":{"westernAmerican":[""],"westernEuropean":[""],"southAmerican":[""],"russia":[""],"india":["seeing","knowing"],"northAfrica":[""],"southAfrica":[""],"muslim":[""],"asia":[""],"chinese":[""],"japanese":[""],"nativeAmericans":[""]}},{"hex":"#a9713d","name":"brown",rgb:{r:0,g:0,b:0},"cultures":{"westernAmerican":["uncultivated","laziness","security","spoiled","reliable","solid","romantic","warm","earthy","rustic"],"westernEuropean":[""],"southAmerican":[""],"russia":[""],"india":[""],"northAfrica":[""],"southAfrica":[""],"muslim":[""],"asia":[""],"chinese":[""],"japanese":["the outdoors","simplicity","endurance","home","earth","comfort"],"nativeAmericans":["self-discipline","knowing","good"]}},{"hex":"#1d1d1b","name":"black",rgb:{r:0,g:0,b:0},"cultures":{"westernAmerican":["mourning","death","overpowering","aloof","evil","submission","eternity","style","power","authority"],"westernEuropean":["mourning"],"southAmerican":[""],"russia":[""],"india":["anger","darkness","negativity","inertia","evil","penance"],"northAfrica":[""],"southAfrica":[""],"muslim":["mourning","clergy","devotion (Shi'ite women)"],"asia":["career","knowledge","self-cultivation","mourning","evil influences","penance"],"chinese":["young boys","reliability","trust"],"japanese":["age","fear","mystery","wealth","bad luck","experience","depth","mourning","unhappiness","evil","solemnity","style","class","nobility"],"nativeAmericans":["harmony","reflection","self-examination","death","west","problems"]}},{"hex":"#ffffff","name":"white",rgb:{r:0,g:0,b:0},"cultures":{"westernAmerican":["perishability","clarity","tranquility","luxury","vagueness","emptyness","bride","sterility","neutral","purity","summer","truce"],"westernEuropean":[""],"southAmerican":[""],"russia":["truce"],"india":["death and rebirth","brightness","peace","tranquility","truce"],"northAfrica":[""],"southAfrica":["truce"],"muslim":["prayer","death","peace","putiry","truce"],"asia":["mourning","travel","children","peace","putiry","marriage"],"chinese":["mourning","death","truce"],"japanese":["humilty","mourning (black and white worn at funerals)","death","youth","sacred","reverence","cleanliness","putiry","truce"],"nativeAmericans":["sharing","magnetism","happiness","peace","warmth"]}},{"hex":"#ed7aa2","name":"pink",rgb:{r:0,g:0,b:0},"cultures":{"westernAmerican":["girl","feminine","cute","tranquillising"],"westernEuropean":[""],"southAmerican":[""],"russia":[""],"india":[""],"northAfrica":[""],"southAfrica":[""],"muslim":[""],"asia":["marriage"],"chinese":[""],"japanese":["flirtatious","purity","sexuality","life","good health","girlish","feminine","child-like personality"],"nativeAmericans":["motivation","seeing","working","creativity"]}},{"hex":"#7c7b7a","name":"grey",rgb:{r:0,g:0,b:0},"cultures":{"westernAmerican":["pollution","decay","boredom","respect","elegance","humility"],"westernEuropean":[""],"southAmerican":[""],"russia":[""],"india":[""],"northAfrica":[""],"southAfrica":[""],"muslim":[""],"asia":["travel","helpful people"],"chinese":[""],"japanese":["staid","intelligence","reliability","old age","conservative","modesty"],"nativeAmericans":["honouring","friendship"]}},{"hex":"#ffe500","name":"gold",rgb:{r:0,g:0,b:0},"cultures":{"westernAmerican":["wealth","money"],"westernEuropean":[""],"southAmerican":[""],"russia":[""],"india":[""],"northAfrica":[""],"southAfrica":[""],"muslim":[""],"asia":["strength","wealth"],"chinese":["happiness","wealth"],"japanese":["the heavens","religion","royalty"],"nativeAmericans":[""]}}];this.hex2rgb=function(object){object.rgb.r="";object.rgb.g="";object.rgb.b="";if(object.hex.charAt(0)=='#'){object.hex=object.hex.substr(1);}
object.rgb.r=object.hex.charAt(0)+object.hex.charAt(1);object.rgb.g=object.hex.charAt(2)+object.hex.charAt(3);object.rgb.b=object.hex.charAt(4)+object.hex.charAt(5);object.rgb.r=parseInt(object.rgb.r,16);object.rgb.g=parseInt(object.rgb.g,16);object.rgb.b=parseInt(object.rgb.b,16);};this.init=function(){var that=this;this.hex2rgb(this.currentColor);this.data.map(function(object){that.hex2rgb(object);that.differenceArray.push(Math.sqrt((object.rgb.r-that.currentColor.rgb.r)*(object.rgb.r-that.currentColor.rgb.r)+(object.rgb.g-that.currentColor.rgb.g)*(object.rgb.g-that.currentColor.rgb.g)+(object.rgb.b-that.currentColor.rgb.b)*(object.rgb.b-that.currentColor.rgb.b)));that.lowest=Array.min(that.differenceArray);});var indexOfAnswer=this.differenceArray.indexOf(this.lowest);var cultures=Object.keys(this.data[indexOfAnswer].cultures);var culture="";for(var i=0;cultures.length>i;i++){if(this.currentCulture==cultures[i])culture=Object.values(this.data[indexOfAnswer].cultures)[i];}var answer={name:this.data[indexOfAnswer].name,cultures:culture};return answer;};};var showAsFloat=function showAsFloat(value){return!isNaN(+value)?(+value).toFixed(2):value;};var hexc=function hexc(colorval){var parts=colorval.match(/^rgb\((\d+),\s*(\d+),\s*(\d+)\)$/);delete parts[0];for(var i=1;i<=3;++i){parts[i]=parseInt(parts[i]).toString(16);if(parts[i].length==1)parts[i]='0'+parts[i];}
return'#'+parts.join('');};var List=function(modules){var installedModules={};function __webpack_require__(moduleId){if(installedModules[moduleId])
...
return self;};this.reset={filter:function filter(){var is=self.items,il=is.length;while(il--){is[il].filtered=false;}
return self;},search:function search(){var is=self.items,il=is.length;while(il--){is[il].found=false;}
...
return tmpColumn;}};var search={list:function list(){for(var k=0,kl=_list.items.length;k<kl;k++){search.item(_list.items[k]);}},item:function item(_item2){_item2.found=false;for(var j=0,jl=columns.length;j<jl;j++){if(search.values(_item2.values(),columns[j])){_item2.found=true;return;}}},values:function values(_values2,column){if(_values2.hasOwnProperty(column)){text=_list.utils.toString(_values2[column]).toLowerCase();if(searchString!==""&&text.search(searchString)>-1){return true;}}
return false;},reset:function reset(){_list.reset.search();_list.searched=false;}};var searchMethod=function searchMethod(str){_list.trigger('searchStart');prepare.resetList();prepare.setSearchString(str);prepare.setOptions(arguments);prepare.setColumns();if(searchString===""){search.reset();}else{_list.searched=true;if(customSearch){customSearch(searchString,columns);}else{search.list();}}
_list.update();_list.trigger('searchComplete');return _list.visibleItems;};_list.handlers.searchStart=_list.handlers.searchStart||[];_list.handlers.searchComplete=_list.handlers.searchComplete||[];_list.utils.events.bind(_list.utils.getByClass(_list.listContainer,_list.searchClass),'keyup',function(e){var target=e.target||e.srcElement,alreadyCleared=target.value===""&&!_list.searched;if(!alreadyCleared){searchMethod(target.value);}});_list.utils.events.bind(_list.utils.getByClass(_list.listContainer,_list.searchClass),'input',function(e){var target=e.target||e.srcElement;if(target.value===""){searchMethod('');}});return searchMethod;};},function(module,exports){module.exports=function(list){var buttons={els:undefined,clear:function clear(){for(var i=0,il=buttons.els.length;i<il;i++){list.utils.classes(buttons.els[i]).remove('asc');list.utils.classes(buttons.els[i]).remove('desc');}},getOrder:function getOrder(btn){var predefinedOrder=list.utils.getAttribute(btn,'data-order');if(predefinedOrder=="asc"||predefinedOrder=="desc"){return predefinedOrder;}else if(list.utils.classes(btn).has('desc')){return"asc";}else if(list.utils.classes(btn).has('asc')){return"desc";}else{return"asc";}},getInSensitive:function getInSensitive(btn,options){var insensitive=list.utils.getAttribute(btn,'data-insensitive');if(insensitive==="false"){options.insensitive=false;}else{options.insensitive=true;}},setOrder:function setOrder(options){for(var i=0,il=buttons.els.length;i<il;i++){var btn=buttons.els[i];if(list.utils.getAttribute(btn,'data-sort')!==options.valueName){continue;}
...
elm=undefined;}
return values;};this.set=function(item,values){var getValueName=function getValueName(name){for(var i=0,il=list.valueNames.length;i<il;i++){if(list.valueNames[i].data){var data=list.valueNames[i].data;for(var j=0,jl=data.length;j<jl;j++){if(data[j]===name){return{data:name};}}}else if(list.valueNames[i].attr&&list.valueNames[i].name&&list.valueNames[i].name==name){return list.valueNames[i];}else if(list.valueNames[i]===name){return name;}}};var setValue=function setValue(name,value){var elm;var valueName=getValueName(name);if(!valueName)return;if(valueName.data){item.elm.setAttribute('data-'+valueName.data,value);}else if(valueName.attr&&valueName.name){elm=list.utils.getByClass(item.elm,valueName.name,true);if(elm){elm.setAttribute(valueName.attr,value);}}else{elm=list.utils.getByClass(item.elm,valueName,true);if(elm){elm.innerHTML=value;}}
...
naturalCompare.caseInsensitive=naturalCompare.i=function(a,b){return naturalCompare((''+a).toLowerCase(),(''+b).toLowerCase());};Object.defineProperties(naturalCompare,{alphabet:{get:function get(){return alphabet;},set:function set(value){alphabet=value;alphabetIndexMap=[];var i=0;if(alphabet){for(;i<alphabet.length;i++){alphabetIndexMap[alphabet.charCodeAt(i)]=i;}}
...
if(arr[i].includes("%")){arr[i]=arr[i].replace("%","");arr[i]=Number(arr[i]/100);if(i<3){arr[i]=Math.round(arr[i]*255);}}
...
for(i=1;i<arrlength;i++){if(arr[i].includes("%")){arr[i]=arr[i].replace("%","");arr[i]=Number(arr[i]);if(isNaN(arr[i])){return emptyObject();}
...
for(i=0;i<arrlength;i++){if(arr[i].includes("%")){arr[i]=arr[i].replace("%","");arr[i]=Number(arr[i]);if(isNaN(arr[i])){return emptyObject();}
arr[i]=arr[i]/100;}else{arr[i]=Number(arr[i]);}
if(Number(arr[i])>1){arr[i]=1;}
if(Number(arr[i])<0){arr[i]=0;}}
...
function colorObject(rgb,a,h,s){var hsl=void 0;var hwb=void 0;var cmyk=void 0;var ncol=void 0;var color=void 0;var hue=void 0;var sat=void 0;if(!rgb){return emptyObject();}
if(!a){a=1;}
...
function hslToRgb(hue,sat,light){var t1=void 0;var t2=void 0;var r=void 0;var g=void 0;var b=void 0;hue=hue/60;if(light<=0.5){t2=light*(sat+1);}else{t2=light+sat-light*sat;}
...
function hwbToRgb(hue,white,black){var i=void 0;var rgb=void 0;var rgbArr=[];rgb=hslToRgb(hue,1,0.50);rgbArr[0]=rgb.r/255;rgbArr[1]=rgb.g/255;rgbArr[2]=rgb.b/255;for(i=0;i<3;i++){rgbArr[i]*=1-white-black;rgbArr[i]+=white;rgbArr[i]=Number(rgbArr[i]*255);}
return{r:rgbArr[0],g:rgbArr[1],b:rgbArr[2]};}
function cmykToRgb(c,m,y,k){var r=void 0;var g=void 0;var b=void 0;r=255-Math.min(1,c*(1-k)+k)*255;g=255-Math.min(1,m*(1-k)+k)*255;b=255-Math.min(1,y*(1-k)+k)*255;return{r:r,g:g,b:b};}
function ncolToRgb(ncol,white,black){var letter=void 0;var percent=void 0;var h=void 0;var w=void 0;var b=void 0;h=ncol;if(isNaN(ncol.substr(0,1))){letter=ncol.substr(0,1).toUpperCase();percent=ncol.substr(1);if(percent==""){percent=0;}
...
function ncsToRgb(ncs){var black=void 0;var chroma=void 0;var bc=void 0;var percent=void 0;var black1=void 0;var chroma1=void 0;var red1=void 0;var factor1=void 0;var blue1=void 0;var red2=void 0;var green2=void 0;var blue2=void 0;var max=void 0;var factor2=void 0;var grey=void 0;var r=void 0;var g=void 0;var b=void 0;ncs=w3trim(ncs).toUpperCase();ncs=ncs.replace("(","");ncs=ncs.replace(")","");ncs=ncs.replace("NCS","NCS ");ncs=ncs.replace(/  /g," ");if(!ncs.includes("NCS")){ncs="NCS "+ncs;}
...
red1=(Math.sqrt(14884-factor1**2)-22)/100;}else if(bc==='R'&&percent>80||bc==='B'){red1=0;}else if(bc==='G'){factor1=percent-170;red1=(Math.sqrt(33800-factor1**2)-70)/100;}
...
blue1=(104-Math.sqrt(11236-factor1**2))/100;}else if(bc==='R'&&percent>60||bc==='B'&&percent<=80){if(bc==='R'){factor1=percent-60-60;}else{factor1=percent+40-60;}
blue1=(Math.sqrt(10000-factor1**2)-10)/100;}else if(bc==='B'&&percent>80||bc==='G'&&percent<=40){if(bc==='B'){factor1=percent-80-131;}else{factor1=percent+20-131;}
blue1=(122-Math.sqrt(19881-factor1**2))/100;}else if(bc==='G'&&percent>40){blue1=0;}
if(bc==='Y'){green1=(85-17/20*percent)/100;}else if(bc==='R'&&percent<=60){green1=0;}else if(bc==='R'&&percent>60){factor1=percent-60+35;green1=(67.5-Math.sqrt(5776-factor1**2))/100;}else if(bc==='B'&&percent<=60){factor1=1*percent-68.5;green1=(6.5+Math.sqrt(7044.5-factor1**2))/100;}else if(bc==='B'&&percent>60||bc==='G'&&percent<=60){green1=0.9;}else if(bc==='G'&&percent>60){factor1=percent-60;green1=(90-1/8*factor1)/100;}
...
return{r:r,g:g,b:b};}
function rgbToHsl(r,g,b){var min=void 0;var max=void 0;var i=void 0;var l=void 0;var s=void 0;var maxcolor=void 0;var h=void 0;var rgb=[];rgb[0]=r/255;rgb[1]=g/255;rgb[2]=b/255;min=rgb[0];max=rgb[0];maxcolor=0;for(i=0;i<rgb.length-1;i++){if(rgb[i+1]<=min){min=rgb[i+1];}
...
function rgbToHwb(r,g,b){var h=void 0;var w=void 0;var max=void 0;var min=void 0;var chroma=void 0;r=r/255;g=g/255;b=b/255;max=Math.max(r,g,b);min=Math.min(r,g,b);chroma=max-min;if(chroma==0){h=0;}else if(r==max){h=(g-b)/chroma%6*360;}else if(g==max){h=((b-r)/chroma+2)%6*360;}else{h=((r-g)/chroma+4)%6*360;}
w=min;b=1-max;return{h:h,w:w,b:b};}
function rgbToCmyk(r,g,b){var c=void 0;var m=void 0;var y=void 0;var k=void 0;var max=void 0;r=r/255;g=g/255;b=b/255;max=Math.max(r,g,b);k=1-max;if(k==1){c=0;m=0;y=0;}else{c=(1-r-k)/(1-k);m=(1-g-k)/(1-k);y=(1-b-k)/(1-k);}
return{c:c,m:m,y:y,k:k};}
function toHex(n){var hex=n.toString(16);while(hex.length<2){hex="0"+hex;}
return hex;}
function cl(x){console.log(x);}
function w3trim(x){return x.replace(/^\s+|\s+$/g,'');}
function w3SetColorsByAttribute(){var z=void 0;var i=void 0;var att=void 0;z=document.getElementsByTagName("*");for(i=0;i<z.length;i++){att=z[i].getAttribute("data-w3-color");if(att){z[i].style.backgroundColor=w3color(att).toRgbString();}}}